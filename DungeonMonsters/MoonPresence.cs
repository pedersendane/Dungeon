...
{
    public class MoonPresence : Monster
    {
        //No fields
        ...
        public MoonPresence(string name, int life, int maxLife, int hitChance, int block, int maxDamage, int minDamage, string description)
